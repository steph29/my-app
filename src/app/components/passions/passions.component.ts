...
export class PassionsComponent implements OnInit {
  contentItem = [
    ...
    },
    {
      ...
      contentText:
        "Ben oui, faut bien compenser les bons apéros ! Adepte des petites courses entre 10 et 15 km, j'essaie de courir en moyenne 1 à 2 fois par semaine. Le plus dur? c'est de se lancer, mais une fois parti !",
      contentIcon: '/assets/images/fly.svg',
    },
    {
      contentId: 2,
